...
import { loginUser, socialLogin } from '../../State/Authentication/Action';
    ...
    const handleSocialLogin = (provider) => {
        ...
        if (!clientID) {
            const useDemo = window.confirm(
                ...
                `Bấm [OK] để đăng nhập nhanh bằng tài khoản test ở chế độ DEMO.\n` +
        ...
        if (provider === "google") {
            const redirectUri = "http://localhost:5173/account/login";
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="flex items-center my-4">
                ...
                <span className="mx-4 text-gray-500 text-sm font-semibold">Hoặc tiếp tục với</span>
                <div className="flex-1 border-t border-gray-300" />
            </div>
